...
class AppMessages:
    ...
    NO_DEVICES_FULL = "No COM devices detected."
    PORT_PAIR_CREATED = "Virtual COM pair created successfully"
    PORT_PAIR_REMOVED = "Virtual COM pair removed successfully"
    HUBCOM_RUNNING = "Hub4com routing service is active"
