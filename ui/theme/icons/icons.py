...
class AppIcons:
    ...
    CREATE = """
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path style="color:#363636;fill:currentColor;fill-opacity:1;stroke:none" d="M7 3.006V8H2v.998h5v5.01h1v-5.01h5V8H8V3.006z"/></svg>
    """
